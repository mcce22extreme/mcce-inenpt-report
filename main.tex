...
\input{docker-lstlisting/latex.tex}
...
\makeindex
\input{section/Kopf-und-Fusszeile}
...
\input{section/GitLab}
\input{section/Infrastructure}
\input{section/Software}
\input{section/VerificationTesting}
\input{section/KnownIssues}
%	\begin{comment}
...
%\nocite{*}
\input{section/Literaturverzeichnis}

%\bibliography{References}
\input{section/Abbildungsverzeichnis}

\input{section/Codeverzeichnis}
