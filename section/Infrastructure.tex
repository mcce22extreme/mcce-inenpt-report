...
The 'SSH' security group is only enabled on demand when a login is required.
...
The used security groups are 'Default' and 'SSH'.
...
To solve such, an option is to add the following line to '/etc/resolv.conf':
\begin{lstlisting}
	nameserver 1.1.1.1
\end{lstlisting}
\  \\
